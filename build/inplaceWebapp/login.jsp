...
<body>
<form action="duorou。jsp" method="post">
 <div id="base" class="">
      ...
      <div id="u22" class="ax_default text_field">
        <input id="u22_input" type="password" value="" maxlength="16"/>
      </div>

      <!-- Unnamed (提交按钮) -->
      <div id="u23" class="ax_default html_button">
        <input id="u23_input" type="submit" value="登陆"/>
      </div>
